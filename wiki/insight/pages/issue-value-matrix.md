...
問い選びを所与としたまま、アウトプットの精度や速度だけを上げても、低いイシュー度の問いへの答えが精密になるだけである。解の質を上げる行為は、何を解く必要があるかを判定も改善もしないため、後から問いを選び直すという順序は保証されない。

この状態を避けるには、答えを磨き込む前に、その答えによって選択や行動が変わるかを確かめる。問いの必要性と答えの完成度を別の判断として扱うことで、努力を問い選びの代わりにしない。
